...
my_tissue_consumption = TissueConsumption()
my_tissue_consumption.add_coat("Max", 40)
my_tissue_consumption.add_suit("Mary", 125)
print(f"Общий расход ткани: {round(my_tissue_consumption.count_consumption, 2)}")